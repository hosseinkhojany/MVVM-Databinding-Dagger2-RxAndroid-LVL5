...
import james_gosling.projects.kotlin_mvvm.di.PreferenceInfo;
...
public class AppPrefHelper implements PrefHelper {
    ...
    public int getCurrentUserLoggedInMode() {
        return mPrefs.getInt(PREF_KEY_USER_LOGGED_IN_MODE,
                LoginState.LOGIN_STATE_MODE_LOGGED_OUT.getType());
    }

    @Override
    public void setCurrentUserLoggedInMode(LoginState mode) {
